...
class FillPermissionsForCandidateWard extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCandidateWard constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.candidate-ward',
            'admin.candidate-ward.index',
            'admin.candidate-ward.create',
            'admin.candidate-ward.show',
            'admin.candidate-ward.edit',
            'admin.candidate-ward.delete',
            'admin.candidate-ward.bulk-delete',
        ]);
