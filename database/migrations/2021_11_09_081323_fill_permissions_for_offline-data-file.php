...
class FillPermissionsForOfflineDataFile extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOfflineDataFile constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.offline-data-file',
            'admin.offline-data-file.index',
            'admin.offline-data-file.create',
            'admin.offline-data-file.show',
            'admin.offline-data-file.edit',
            'admin.offline-data-file.delete',
            'admin.offline-data-file.bulk-delete',
        ]);
