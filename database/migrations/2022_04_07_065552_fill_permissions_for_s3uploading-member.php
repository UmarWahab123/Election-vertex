...
class FillPermissionsForS3uploadingMember extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForS3uploadingMember constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.s3uploading-member',
            'admin.s3uploading-member.index',
            'admin.s3uploading-member.create',
            'admin.s3uploading-member.show',
            'admin.s3uploading-member.edit',
            'admin.s3uploading-member.delete',
            'admin.s3uploading-member.bulk-delete',
        ]);
