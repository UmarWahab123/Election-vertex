...
class FillPermissionsForPollingStation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPollingStation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.polling-station',
            'admin.polling-station.index',
            'admin.polling-station.create',
            'admin.polling-station.show',
            'admin.polling-station.edit',
            'admin.polling-station.delete',
            'admin.polling-station.bulk-delete',
        ]);
