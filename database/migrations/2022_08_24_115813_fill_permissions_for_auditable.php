...
class FillPermissionsForAuditable extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAuditable constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.auditable',
            'admin.auditable.index',
            'admin.auditable.create',
            'admin.auditable.show',
            'admin.auditable.edit',
            'admin.auditable.delete',
            'admin.auditable.bulk-delete',
        ]);
