...
class FillPermissionsForClientSetting extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForClientSetting constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.client-setting.index',
            'admin.client-setting.create',
            'admin.client-setting.show',
            'admin.client-setting.edit',
            'admin.client-setting.delete',
            'admin.client-setting.bulk-delete',
        ]);
