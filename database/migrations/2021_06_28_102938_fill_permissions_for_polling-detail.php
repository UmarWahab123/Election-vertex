...
class FillPermissionsForPollingDetail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPollingDetail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.polling-detail',
            'admin.polling-detail.index',
            'admin.polling-detail.create',
            'admin.polling-detail.show',
            'admin.polling-detail.edit',
            'admin.polling-detail.delete',
            'admin.polling-detail.bulk-delete',
        ]);
