...
class FillPermissionsForUrlUploadLog extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUrlUploadLog constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.url-upload-log',
            'admin.url-upload-log.index',
            'admin.url-upload-log.create',
            'admin.url-upload-log.show',
            'admin.url-upload-log.edit',
            'admin.url-upload-log.delete',
            'admin.url-upload-log.bulk-delete',
        ]);
