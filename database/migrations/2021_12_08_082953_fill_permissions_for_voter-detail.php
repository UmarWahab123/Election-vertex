...
class FillPermissionsForVoterDetail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVoterDetail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.voter-detail',
            'admin.voter-detail.index',
            'admin.voter-detail.create',
            'admin.voter-detail.show',
            'admin.voter-detail.edit',
            'admin.voter-detail.delete',
            'admin.voter-detail.bulk-delete',
        ]);
