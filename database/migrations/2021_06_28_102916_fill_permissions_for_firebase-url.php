...
class FillPermissionsForFirebaseUrl extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFirebaseUrl constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.firebase-url',
            'admin.firebase-url.index',
            'admin.firebase-url.create',
            'admin.firebase-url.show',
            'admin.firebase-url.edit',
            'admin.firebase-url.delete',
            'admin.firebase-url.bulk-delete',
        ]);
