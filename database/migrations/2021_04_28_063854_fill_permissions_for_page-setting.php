...
class FillPermissionsForPageSetting extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPageSetting constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.page-setting',
            'admin.page-setting.index',
            'admin.page-setting.create',
            'admin.page-setting.show',
            'admin.page-setting.edit',
            'admin.page-setting.delete',
            'admin.page-setting.bulk-delete',
        ]);
