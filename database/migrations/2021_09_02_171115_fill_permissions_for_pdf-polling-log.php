...
class FillPermissionsForPdfPollingLog extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPdfPollingLog constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pdf-polling-log',
            'admin.pdf-polling-log.index',
            'admin.pdf-polling-log.create',
            'admin.pdf-polling-log.show',
            'admin.pdf-polling-log.edit',
            'admin.pdf-polling-log.delete',
            'admin.pdf-polling-log.bulk-delete',
        ]);
