...
class FillPermissionsForCurlSwitch extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCurlSwitch constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.curl-switch',
            'admin.curl-switch.index',
            'admin.curl-switch.create',
            'admin.curl-switch.show',
            'admin.curl-switch.edit',
            'admin.curl-switch.delete',
            'admin.curl-switch.bulk-delete',
        ]);
