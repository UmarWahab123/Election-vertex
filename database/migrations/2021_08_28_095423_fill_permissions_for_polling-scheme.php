...
class FillPermissionsForPollingScheme extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPollingScheme constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.polling-scheme',
            'admin.polling-scheme.index',
            'admin.polling-scheme.create',
            'admin.polling-scheme.show',
            'admin.polling-scheme.edit',
            'admin.polling-scheme.delete',
            'admin.polling-scheme.bulk-delete',
        ]);
