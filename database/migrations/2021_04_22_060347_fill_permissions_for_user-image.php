...
class FillPermissionsForUserImage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserImage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-image',
            'admin.user-image.index',
            'admin.user-image.create',
            'admin.user-image.show',
            'admin.user-image.edit',
            'admin.user-image.delete',
            'admin.user-image.bulk-delete',
        ]);
