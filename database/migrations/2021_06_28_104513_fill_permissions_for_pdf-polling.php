...
class FillPermissionsForPdfPolling extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPdfPolling constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pdf-polling',
            'admin.pdf-polling.index',
            'admin.pdf-polling.create',
            'admin.pdf-polling.show',
            'admin.pdf-polling.edit',
            'admin.pdf-polling.delete',
            'admin.pdf-polling.bulk-delete',
        ]);
