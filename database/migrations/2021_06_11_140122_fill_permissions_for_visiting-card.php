...
class FillPermissionsForVisitingCard extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVisitingCard constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.visiting-card',
            'admin.visiting-card.index',
            'admin.visiting-card.create',
            'admin.visiting-card.show',
            'admin.visiting-card.edit',
            'admin.visiting-card.delete',
            'admin.visiting-card.bulk-delete',
        ]);
