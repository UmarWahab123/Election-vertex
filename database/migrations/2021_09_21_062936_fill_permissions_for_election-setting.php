...
class FillPermissionsForElectionSetting extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForElectionSetting constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.election-setting',
            'admin.election-setting.index',
            'admin.election-setting.create',
            'admin.election-setting.show',
            'admin.election-setting.edit',
            'admin.election-setting.delete',
            'admin.election-setting.bulk-delete',
        ]);
