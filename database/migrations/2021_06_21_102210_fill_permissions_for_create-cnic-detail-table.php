...
class FillPermissionsForCreateCnicDetailTable extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCreateCnicDetailTable constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.create-cnic-detail-table',
            'admin.create-cnic-detail-table.index',
            'admin.create-cnic-detail-table.create',
            'admin.create-cnic-detail-table.show',
            'admin.create-cnic-detail-table.edit',
            'admin.create-cnic-detail-table.delete',
            'admin.create-cnic-detail-table.bulk-delete',
        ]);
