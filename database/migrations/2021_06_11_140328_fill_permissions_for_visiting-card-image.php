...
class FillPermissionsForVisitingCardImage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVisitingCardImage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.visiting-card-image',
            'admin.visiting-card-image.index',
            'admin.visiting-card-image.create',
            'admin.visiting-card-image.show',
            'admin.visiting-card-image.edit',
            'admin.visiting-card-image.delete',
            'admin.visiting-card-image.bulk-delete',
        ]);
