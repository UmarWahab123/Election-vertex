...
class FillPermissionsForDataSet extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDataSet constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.data-set',
            'admin.data-set.index',
            'admin.data-set.create',
            'admin.data-set.show',
            'admin.data-set.edit',
            'admin.data-set.delete',
            'admin.data-set.bulk-delete',
        ]);
