...
class FillPermissionsForGeneralNotice extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGeneralNotice constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.general-notice.index',
            'admin.general-notice.create',
            'admin.general-notice.show',
            'admin.general-notice.edit',
            'admin.general-notice.delete',
            'admin.general-notice.bulk-delete',
        ]);
