...
class FillPermissionsForAllParty extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAllParty constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.all-party',
            'admin.all-party.index',
            'admin.all-party.create',
            'admin.all-party.show',
            'admin.all-party.edit',
            'admin.all-party.delete',
            'admin.all-party.bulk-delete',
        ]);
