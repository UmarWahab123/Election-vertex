...
class FillPermissionsForElectionSector extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForElectionSector constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.election-sector',
            'admin.election-sector.index',
            'admin.election-sector.create',
            'admin.election-sector.show',
            'admin.election-sector.edit',
            'admin.election-sector.delete',
            'admin.election-sector.bulk-delete',
        ]);
