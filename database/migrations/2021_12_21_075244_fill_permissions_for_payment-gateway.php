...
class FillPermissionsForPaymentGateway extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPaymentGateway constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.payment-gateway.show',
            'admin.payment-gateway.edit',
            'admin.payment-gateway.delete',
            'admin.payment-gateway.bulk-delete',
        ]);
