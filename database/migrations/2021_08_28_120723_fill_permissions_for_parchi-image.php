...
class FillPermissionsForParchiImage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForParchiImage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.parchi-image',
            'admin.parchi-image.index',
            'admin.parchi-image.create',
            'admin.parchi-image.show',
            'admin.parchi-image.edit',
            'admin.parchi-image.delete',
            'admin.parchi-image.bulk-delete',
        ]);
