                                ...
                                <div class="vparchi-r2 flex" dir="rtl">
                                    <div class="field field-address" data-key="{{ $key }}" data-name="address">
                                        ...
                                        <div class="value">
                                            <div class="three">
                                                ...
                                                <img src="{{"data:image/png;base64,".@$line->polling_details_images->name_pic}}" alt="Red dot"  height="55px" width="97%" loading="lazy" />
                                    ...
                                    <div class="field field-address" data-key="{{ $key }}" data-name="address">
                                        ...
                                        <div class="value">   <div class="item-address">
                                                    ...
                                                    <img src="{{"data:image/png;base64,".@$line->polling_details_images->address_pic}}" alt="Red dot"  height="55px" width="97%" loading="lazy" />
...
{{--                                <div class="three">--}}
{{--                                    @if($line->type == 'cld')--}}
{{--                                        <img src="https://res.cloudinary.com/one-call-app/image/fetch/c_crop,h_{{json_decode($line->crop_settings , true)['h']}},w_900,x_1800,y_{{json_decode($line->crop_settings , true)['y']}}/{{urlencode(@$line->url)}}" alt="Row Image" height="55px" width="97%"  loading="lazy">--}}
{{--                                    @elseif($line->type == 'textract')--}}
{{--                                        <img src="https://res.cloudinary.com/one-call-app/image/fetch/c_crop,h_{{json_decode($line->crop_settings , true)['h']}},w_0.24435,x_0.58,y_{{json_decode($line->crop_settings , true)['y']}}/{{urlencode(@$line->url)}}" alt="Row Image" height="55px" width="97%"  loading="lazy">--}}
{{--                                    @endif--}}
{{--                                </div>--}}
