            ...
            <table align="center" cellspacing="5" style="border: none;">
                ...
                <tr>
                    ...
                    <td colspan="7" style="border: 2px solid black; border-right: none; text-align:right">
                        @if(@$detail->crop_settings !== null)
                            @if(@$detail->type == 'cld')
                                <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_{{json_decode(@$detail->crop_settings , true)['h']}},w_900,x_1800,y_{{json_decode(@$detail->crop_settings , true)['y']}}/{{urlencode(@@$detail->url)}}" alt="Row Image" width="90%" >
                            @elseif(@$detail->type == 'textract')
                                <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_0.035326910972595,w_0.24435,x_0.6,y_{{json_decode(@$detail->crop_settings , true)['y']}}/{{urlencode(@@$detail->url)}}" alt="Row Image" width="90%" >
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    <td colspan="7" style="border: 2px solid black; border-right: none; text-align:right">
                        @if(@$detail->crop_settings !== null)
                            @if(@$detail->type == 'cld')
                                <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_{{json_decode(@$detail->crop_settings , true)['h']}},w_900,x_340,y_{{json_decode(@$detail->crop_settings , true)['y']}}/{{urlencode(@@$detail->url)}}" alt="Row Image" width="90%" >
                            @elseif(@$detail->type == 'textract')
                                <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_0.035326910972595,w_0.32435,x_0.07,y_{{json_decode(@$detail->crop_settings , true)['y']}}/{{urlencode(@@$detail->url)}}" alt="Row Image" width="90%" >
                            @endif
                        @endif
                    </td>
