...
<div class="main_container">
    ...
    <div class="col-12">
        <div style="margin: 50%; text-align: center;">
            <h1 style="font-size: 55px; font-weight: bold"><b>Male voter </b></h1>
            <h1 style="font-size: 55px; font-weight: bold"><b>{{@$electionSector->male_vote}}</b></h1>
        </div>
    </div>


    <div class="pagebreak"> </div>
    @foreach($mpolling_details as $key => $line)
                            ...
                            <div class="value">
                                <div class="three">
                                    ...
                                    @elseif($dpi === 400)
                                        ...
                                        @elseif($line->type == 'textract')
                                            <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_{{json_decode($line->crop_settings , true)['h']}},w_0.24435,x_0.58,y_{{json_decode($line->crop_settings , true)['y']}}/{{urlencode(@$line->url)}}" alt="Row Image" height="55px" width="97%"  loading="lazy">
                                        @endif
                                    @endif
                                </div>
                        ...
                        <div class="field field-address" data-key="{{ $key }}" data-name="address">
                            ...
                            <div class="value">   <div class="item-address">
                                    ...
                                    @elseif($dpi === 400)
                                        ...
                                        @elseif($line->type == 'textract')
                                            <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_{{json_decode($line->crop_settings , true)['h']}},w_0.32435,x_0.07,y_{{json_decode($line->crop_settings , true)['y']}}/{{urlencode(@$line->url)}}" alt="Row Image" width="97%" height="55px"  loading="lazy">
                                        @endif
                                    @endif
                                </div></div>
...
{{--{{$mpolling_details->links()}}--}}
    <div class="col-12">
        <div style="margin: 50%; text-align: center;">
            <h1 style="font-size: 55px; font-weight: bold"><b>Female voter </b></h1>
            <h1 style="font-size: 55px; font-weight: bold"><b>{{@$electionSector->female_vote}}</b></h1>
        </div>
    </div>
    ...
    @foreach($fpolling_details as $key => $line)
        @if(1)
            <div class="parchi_inr_wrapper" data-key="{{$key}}">
                <div class="parchi_lft_col">
                    <div class="label">
                                ...
                                <div class="item-address">
                                    ...
                                    @if($dpi === 300)
                                        @if($line->type == 'cld')
                                            <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_{{json_decode($line->crop_settings , true)['h']}},w_800,x_200,y_{{json_decode($line->crop_settings , true)['y']}}/{{urlencode(@$line->url)}}" alt="Row Image" height="55px" width="97%" loading="lazy">
                                        @elseif($line->type == 'textract')
                                            <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_{{json_decode($line->crop_settings , true)['h']}},w_0.30435,x_0.01,y_{{json_decode($line->crop_settings , true)['y']}}/{{urlencode(@$line->url)}}" alt="Row Image" width="97%" height="55px"  loading="lazy">
                                        @endif
                                    @elseif($dpi === 400)
                                        @if($line->type == 'cld')
                                            <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_{{json_decode($line->crop_settings , true)['h']}},w_900,x_340,y_{{json_decode($line->crop_settings , true)['y']}}/{{urlencode(@$line->url)}}" alt="Row Image" height="55px" width="97%" loading="lazy">
                                        @elseif($line->type == 'textract')
                                            <img src="https://res.cloudinary.com/election-experts/image/fetch/c_crop,h_{{json_decode($line->crop_settings , true)['h']}},w_0.32435,x_0.06,y_{{json_decode($line->crop_settings , true)['y']}}/{{urlencode(@$line->url)}}" alt="Row Image" width="97%" height="55px"  loading="lazy">
                                        @endif
                                    @endif
