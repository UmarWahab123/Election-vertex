...
<script src="https://www.gstatic.com/firebasejs/8.1.2/firebase-storage.js"></script>
    ...
    <div id="cat_img"></div>
    <br><br><br>
    <input type="submit" id="startvision" value="Process Vision Api">
 </body>
...
<script type="text/javascript">
            ...
            for(let i = 0; i < files.length; i++) {
                uploadImageOnFirebase(files[i])
                    .then(downloadURL => {
                        ...
                        $("#cat_img").append(`<input type="text" id="fb_url" name="image_url" value='${downloadURL}'/>`)
                        $("#upim").append(`<img   src='${downloadURL}'  style='height: 427px !important;'>`)
                    })
            }
        })
    }
    ...
    $(document).ready(function () {
        ...
        $('#startvision').click(function(e) {

            var url = document.querySelector('#fb_url').value;
            console.log('ready')

            $.ajax({
                url: 'https://vertex.plabesk.com/api/usman/v-test?token=$2y$10$X6Y0dBD072OdaOlEUMh4ue.6osLcDqs7Knjh191LRlA69vcsBJT72',
                type: "post",
                beforeSend: function () {            console.log('processing')          },
                data: {
                    url:url,
