    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @can('admin.staff')
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/firebase/categorizeImageUpload') }}"><i class="nav-icon icon-user"></i>Image Upload</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/payment-gateways/') }}"><i class="nav-icon icon-umbrella"></i>Payment Gateway</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/firebase-urls/invalid') }}"><i class="nav-icon icon-umbrella"></i>Invalid Urls</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/customers') }}"><i class="nav-icon icon-puzzle"></i>Customer</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/customers/order') }}"><i class="nav-icon icon-puzzle"></i>Order</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/customers/ledger') }}"><i class="nav-icon icon-puzzle"></i>Ledger</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/election-sectors/get-download-json-files') }}"><i class="nav-icon icon-puzzle"></i>Download JSON Files</a></li>
            ...
            @can('admin.politics.imageuplaod')
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/admin-users') }}"><i class="nav-icon icon-user"></i> {{ __('Manage access') }}</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/firebase/categorizeImageUpload') }}"><i class="nav-icon icon-user"></i>Image Upload</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/election-sectors') }}"><i class="nav-icon icon-user"></i>Election Sectors</a></li>
            ...
            @can('admin.vertex-demonstration')
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/admin-users/dashboard') }}"><i class="nav-icon icon-puzzle"></i>{{ trans('Dashboards') }}</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/firebase/categorizeImageUpload') }}"><i class="nav-icon icon-compass"></i>{{ trans('Image Uploads') }}</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/election-sectors') }}"><i class="nav-icon icon-user"></i>{{ trans('Election Sectors') }}</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/parchi-images') }}"><i class="nav-icon icon-user"></i>{{ trans('Candidate Details') }}</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/polling-schemes') }}"><i class="nav-icon icon-user"></i>{{ trans('Polling Schemes') }}</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/election/search-id-card-parchi') }}"><i class="nav-icon icon-compass"></i>{{ trans('Search Voter') }}</a></li>
