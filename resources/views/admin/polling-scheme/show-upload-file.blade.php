...
<form action="{{url('admin/polling-schemes/update-image-upload')}}" method="post">
    ...
    <div class="row">
        ...
        <div class="col-md-4 grid">
            <div class="field">
                <input type="text" name="polling_station_area" placeholder="Polling station Area.." >
            </div>
        </div>
        <div class="col-md-4 grid">
            <div class="field">
                <input type="text" name="polling_station_area_urdu" placeholder="Polling station Area Urdu..." >
            </div>
        </div>
        <div class="col-md-4 grid">
            <div class="field">
                <input type="text" name="gender_type" placeholder="Gender type..." >
            </div>
        </div>
        <div class="col-md-4 grid">
            <div class="field">
                <input type="text" name="block_code_area" placeholder="Block Code Area.." >
            </div>
        </div>
        <div class="col-md-4 grid">
            <div class="field">
                <input type="text" name="block_code" placeholder="Block Code.." >
            </div>
        </div>
        <div class="col-md-4 grid">
            <div class="field">
                <input type="text" name="male_code" placeholder="Male Both..." >
            </div>
        </div>
        <div class="col-md-4 grid">
            <div class="field">
                <input type="text" name="female_code" placeholder="Female Both..." >
            </div>
        </div>
        <div class="col-md-4 grid">
            <div class="field">
                <input type="text" name="total_both" placeholder="Total Both..." >
            </div>
        </div>
