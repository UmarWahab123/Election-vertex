...
<head>
    ...
    <title>{{@$generalSetting->reg_title}}</title>
...
<body>
    ...
    <section class="profile-body">
        ...
        <form class="submit" id="submit">
            ...
            <div class="form">
                ...
                <div class="field">
                    <input type="hidden" id="full_name" placeholder="Full Name*" class="full_name" name="full_name" required>
                </div>
                <div class="field">
                    <input type="hidden" id="username" maxlength="12" placeholder="Mobile Number*" class="mobile_number"  name="mobile_number" required>
                </div>
                ...
                <div class="field">
                    <input type="text"  id="{{$row->id}}" placeholder="{{@$row->tag_name}}" class="tag_name" name="tag_name[]" required>
                </div>
                @endforeach
    ...
    <div id="AlreadyUser" class="modal slide-from-bottom" style="display: none;">
        ...
        <div class="modal-content">
            <div class="text">
                ...
                <p>Your Profile Already Register!</p>
            </div>
            <!-- Footer with buttons -->
            <div class="modal-footer">
                <div class="modal-button-group">
    ...
    <div id="errormodel" class="modal slide-from-bottom" style="display: none;">
        <div class="modal-content">
            ...
            <center> <h2>Kindly Enter Your Complete Details</h2></center>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="modal-button-group">
                    <div class="spaces"></div>
                    <span class="close-button">
                        <div class="btn-danger modal-button-item"  onClick="window.location.reload();">
                            OK
                        </div>
                    </span>
                </div>
     ...
     $.ajax({
        ...
        success:function(response) {
            if (response['mesage'] == 'A') {
                    ...
                    window.location.href="https://onecallschool.plabesk.com/admin/mobileView/businessPageView/" + $('.business_id').val() + '/' + response.message;
                }
                if (response['mesage'] == 'W') {
                    document.getElementById('AlreadyREGISTER').style.display="none";
                }
...
<script>
    function reload() {
         window.location.href="https://vertex.plabesk.com/admin/mobileView/" + $('.business_id').val();
    }
