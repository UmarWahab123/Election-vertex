...
class PendingPdf extends Command
{
     ...
     * @var string
     */
    protected $signature = 'pendingpdf:run';
...
//
//            $link = 'https://vertex.plabesk.com/api/download-files/'.$sendMailDetails->block_code.'/'.$_type;
//
