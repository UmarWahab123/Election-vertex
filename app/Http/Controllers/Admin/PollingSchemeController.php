...
//        dd($polling_scheme);
        ...
        // pass the request with params
            ...
            ['id', 'ward', 'block_code', 'latlng', 'status','polling_station_area_urdu','polling_station_area','serial_no','image_url','gender_type'],

            // set columns to searchIn
            ['id', 'ward', 'polling_station_area','block_code', 'block_code_area', 'latlng', 'status','polling_station_area_urdu','serial_no','gender_type'],

            function($query) use ($request)
            {
//                ->where('image_url',null)
//            $query->where('ward','NA-133')->orderby('id','DESC');
            }
        );
...
//           'polling_station_area_urdu'=>$request->polling_station_urdu,
